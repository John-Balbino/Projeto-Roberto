...
export function MobileFooterMenu() {
  return (
    <nav className="fixed bottom-0 w-full rounded-xl  bg-black shadow-md border-t border-gray-200 md:hidden z-50">
      <ul className="flex justify-around items-center py-2 text-amber-600 ">
        ...
        <li>
          <Link to="/contato" className="flex flex-col l items-center text-sm">
